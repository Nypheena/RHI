...
- Fixed shader pack exclusion writes (`SetExcludedFiles`) blocking the UI thread when confirming the shader picker or installing the Feeder addon — writes are now offloaded to a background thread.
